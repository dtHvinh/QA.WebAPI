...
namespace WebAPI.Migrations
{
    ...
    [Migration("20250225011429_Updatekjada")]
    partial class Updatekjada
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Model.QuestionVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI.Model.RollBackAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SuggestEditId");

                    b.ToTable("RollBackAction");
                });

            modelBuilder.Entity("WebAPI.Model.SuggestEdit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SuggestEditTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SuggestEditTypeId");

                    b.ToTable("SuggestEdit");
                });

            modelBuilder.Entity("WebAPI.Model.SuggestEditType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI.Model.RollBackAction", b =>
                {
                    ...
                    b.HasOne("WebAPI.Model.SuggestEdit", "SuggestEdit")
                        .WithMany()
                        .HasForeignKey("SuggestEditId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Author");

                    b.Navigation("SuggestEdit");
                });
            ...
            modelBuilder.Entity("WebAPI.Model.SuggestEdit", b =>
                {
                    ...
                    b.HasOne("WebAPI.Model.QuestionVersion", "QuestionVersion")
                        .WithMany()
                        .HasForeignKey("QuestionVersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebAPI.Model.SuggestEditType", "SuggestEditType")
                        .WithMany()
                        .HasForeignKey("SuggestEditTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

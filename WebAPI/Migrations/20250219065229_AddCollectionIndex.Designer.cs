...
namespace WebAPI.Migrations
{
    ...
    [Migration("20250219065229_AddCollectionIndex")]
    partial class AddCollectionIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuestionQuestionCollection", b =>
                {
                    b.Property<int>("QuestionCollectionsId")
                        .HasColumnType("int");

                    b.Property<int>("QuestionsId")
                        .HasColumnType("int");

                    b.HasKey("QuestionCollectionsId", "QuestionsId");

                    b.HasIndex("QuestionsId");

                    b.ToTable("QuestionQuestionCollection");
                });
            ...
            modelBuilder.Entity("WebAPI.Model.QuestionCollection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuestionQuestionCollection", b =>
                {
                    b.HasOne("WebAPI.Model.QuestionCollection", null)
                        .WithMany()
                        .HasForeignKey("QuestionCollectionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebAPI.Model.CollectionLike", b =>
                {
                    ...
                    b.HasOne("WebAPI.Model.QuestionCollection", "Collection")
                        .WithMany()
